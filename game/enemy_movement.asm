...
;; 	PHA 	;push low byte
	...
	;; took out rts jmp table because enemies ran better without it. probably not the best choice for this routine, but could be used later.
...
@TopWallJump:
	...
	STA TopWall_Flag
	JMP EnDown
	;; JMP GoingDown 		;move en down immediately
@GetUpTile:
	JSR Tile_Translate
	CMP #$04
	BNE @CheckRock
